        ...
        <div className={styles.container}>
            <aside className={styles.sidebar}>
                ...
                <nav className={styles.sidebarNav}>
                    <Link href="/" className={isActive('/dashboard') ? styles.active : ''}>
                        <span>🏠</span> Safety Dashboard
                    </Link>
                    <Link href="/users" className={isActive('/users') ? styles.active : ''}>
                        <span>👥</span> People List
                    </Link>
                    <Link href="/sos" className={isActive('/sos') ? styles.active : ''}>
                        <span>🚨</span> Emergency Alerts
                    </Link>
                    <Link href="/geofences" className={isActive('/geofences') ? styles.active : ''}>
                        <span>🛡️</span> Safe Zones
                    </Link>
                    <Link href="/devices" className={isActive('/devices') ? styles.active : ''}>
                        <span>⌚</span> Hardware
                    </Link>
                </nav>
            </aside>
